...
BAS-Guardian is a **scanning/detection tool**, not a versioned service. The latest commit on `main` is always the supported version.
...
1. Open a [GitHub private security advisory](https://github.com/spinfosecurity/BAS-Guardian/security/advisories/new)
...
This tool is intended **exclusively for authorized security assessments** of building automation systems (BAS/BMS), HVAC controllers, and BACnet-enabled devices. Unauthorized scanning is illegal and outside the intended use of this software.
